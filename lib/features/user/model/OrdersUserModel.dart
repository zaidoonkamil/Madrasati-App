...
OrdersUserModel ordersUserModelFromJson(String str) =>
    OrdersUserModel.fromJson(json.decode(str));

String ordersUserModelToJson(OrdersUserModel data) =>
...
class OrdersUserModel {
  ...
  OrdersUserModel({required this.paginationOrdersUser, required this.orders});

  factory OrdersUserModel.fromJson(Map<String, dynamic> json) =>
      OrdersUserModel(
